            ...
            <DragDropContext onDragEnd={handleOnDragEnd}>
                <div className="flex w-full flex-col justify-center items-center">
                    <div className="flex  gap-4 flex-wrap 2xl:flex-nowrap ">
                        <div className="w-full sm:w-2/3 flex gap-1 sm:gap-4 mx-auto">
                            <Droppable droppableId="pending">
                                {(provided) => (
                                    <div className="pending  mt-8 p-4  bg-gradient-to-r from-blue-50 to-white border shadow  rounded-2xl" {...provided.droppableProps} ref={provided.innerRef}>
                                        ...
                                        <div className="flex flex-col w-36 sm:w-60  max-h-72 overflow-auto sm:max-h-auto sm:overflow-auto no-scrollbar">
                                        ...
                                        {!addPending ?
                                            ...
                                            :
                                            <form >
                                                <div className="task text-xl sm:w-56 flex justify-between bg-blue-50 m-2 p-2 shadow rounded-md border-slate-400 border">
                                                    <div className="items-center">
                        ...
                        <div className="w-full sm:w-auto xl:w-1/3 mx-auto fixed bottom-0 left-0 sm:bottom-auto sm:left-auto sm:static">
                            <Droppable droppableId="delete">
                                {(provided) => (
                                    <div className="completed w-full mt-8 px-4 py-4 sm:h-80  bg-gradient-to-r from-blue-50 to-white border shadow  rounded-2xl" {...provided.droppableProps} ref={provided.innerRef}>
                                        <h1 className="text-2xl  text-left px-4 font-bold text-slate-900">Delete Todo</h1>
                                        <div className="w-full bg-gradient-to-r from-red-50 to-red-200 shadow  border border-red-600 h-20 sm:h-60 sm:mx-4 mt-2  sm:w-60 rounded-lg flex justify-center items-center">
